...
print(x2.key)  # unique key used to construct computational graph
...
print(x2_named.key)  # unique key used to construct computational graph
...
print(x3.key)  # unique key used to construct computational graph
...
print(x3_named.key)  # unique key used to construct computational graph
...
print(x4.key)  # unique key used to construct computational graph
...
print(x4_named.key)  # unique key used to construct computational graph
...
x10 = variable(
    [variable("x"), variable("y")], lambda x, y: x**2 + y, display_name="x^2 + y"
)
...
print(obj_1({"x": torch.tensor(5.0)}))
